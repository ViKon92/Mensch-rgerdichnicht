...
public class ConnectionConsole {
    //Quellcode um eine Netzwerkverbindung zwischen zwei Computern herzustellen.
    // Dieser Teil ist für den Host der Sitzung, der andere Teil dient für den Client 
    private static boolean isConnected = false;

    public static void main(String[] args) throws IOException {
        String serverAddress = "10.3.0.115"; //Server-IP-Adresse hier einfügen
